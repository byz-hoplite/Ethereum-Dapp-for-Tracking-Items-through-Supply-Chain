...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function harvestItem() that allows a farmer to harvest coffee", async() => {
		...
		assert.equal(resultBufferTwo[2], productID, 'Error: Item State invalid');
		assert.equal(resultBufferTwo[6], emptyAddress 'Error: Missing/Invalid distributorID');	
		assert.equal(resultBufferTwo[7], emptyAddress 'Error: Missing/Invalid retailerID');
		assert.equal(resultBufferTwo[8], emptyAddress 'Error: Missing/Invalid consumerID');		
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async() => {
        ...
        */
		...
		// Verify if farmer has been included
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        // Verify if distirbutor has been included
